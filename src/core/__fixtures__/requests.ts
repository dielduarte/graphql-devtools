  ...
  request: {
    ...
    headers: [
      ...
      },
      {
        name: 'Referer',
        value:
          'https://dashboard.avantstay.rocks/properties/d7c780dc-bf6c-11e9-bdc9-ab3ca5026a7a/stats?dateRange=prev-7-days&granularity=daily'
      },
      {
        name: 'Origin',
      ...
      callFrames: [
        {
          ...
          scriptId: '377',
          url:
            'https://dashboard.avantstay.rocks/main.d6a88268.js?__WB_REVISION__=df7dd4ed26faf74aa03a',
          lineNumber: 129,
          columnNumber: 50577
        },
        {
  ...
  request: {
    ...
    headers: [
      ...
      },
      {
        name: 'referer',
        value:
          'https://dashboard.avantstay.rocks/properties/d7c780dc-bf6c-11e9-bdc9-ab3ca5026a7a/stats?dateRange=today&granularity=daily'
      },
      {
...
export default { preflightRequest, request };
